...
- You no longer need to dedicate a resource box on character sheet for this mod. However, if you prefer that or there are compatability issues, you can check Legacy Mode option in settings to continue to use it that way. Create a new resource with the name "Spell Points", or whatever you set it to on every character sheet. (Hint: if any of your player need more resources you can use the module https://github.com/ardittristan/5eSheet-resourcesPlus/tree/master)
...
- No longer takes up a resource slot.
